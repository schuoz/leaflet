    ...
    data: () => { return {
      questions:
        ...
        },
        {
            ...
            "info": [{term:'mining', explanation:'Mining is extraction of valuable geological materials from the river channel or nearby '}, {term:'dam', explanation:'A dam is a barrier that stops or restricts the flow of surface water'}],
            "answers": [
              "dam",
              "harbor",
              "bridge",
